...
//increasing hashTables' size & double hashing
public class HashTable2 {
    ...
    public static void main(String[] args) {
        ...
        //theFunc.increaseArraySize(60);//new
        //theFunc.displayTheStack();
        //theFunc.fillArrayWithNeg1();//new

        theFunc.doubleHashFunc(elementsToAdd2, theFunc.theArray);//new
        theFunc.displayTheStack();
        theFunc.findKeyDblHashed("990");//new
    }
